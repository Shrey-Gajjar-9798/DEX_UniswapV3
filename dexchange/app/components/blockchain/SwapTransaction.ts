...
export const swaptransaction = async (token0a: string, token1b: string, amount: any, signer: ethers.Signer | ethers.providers.Provider | undefined) => {
    ...
    try {
        ...
        alert("Something went wrong with the token contract fetching!")
    }
    ...
    try {
        ...
        alert("Something went wrong with token0 minting & approve");
    }
